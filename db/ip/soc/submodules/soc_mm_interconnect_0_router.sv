...
(
    ...
    localparam PAD12 = log2ceil(64'h1c8 - 64'h1c0); 
    localparam PAD13 = log2ceil(64'h1d0 - 64'h1c8); 
    ...
    // ( 0x180 .. 0x190 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 28'h180  && read_transaction  ) begin
            src_channel = 16'b0000100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 13;
    end

    // ( 0x190 .. 0x1a0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 28'h190  && read_transaction  ) begin
            src_channel = 16'b0000010000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 14;
    end

    // ( 0x1a0 .. 0x1b0 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 28'h1a0   ) begin
    ...
    // ( 0x1c8 .. 0x1d0 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 28'h1c8  && read_transaction  ) begin
